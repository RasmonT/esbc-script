...
echo -e "${GREEN} ---------------ESBC Updater v2.3.0.0----------------+
 |                                                  |::
 |                                                  |::
 |               ___  __  ___   __                  |::
 |              |__  /__  |__) /                    |::
 |              |___ .__/ |__) \__                  |::
 |                                                  |::
 |     ${YELLOW}ESBC Updater v 2.3.0.0 which check your      ${GREEN}|::
...
if [ "$(/usr/local/bin/esbcoin-cli --version)" = "ESBC Core RPC client version 2.3.0.0" ]; then
